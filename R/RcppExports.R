...
sample_paternity_and_error_rates_from_joint_posterior <- function(phenotypes, mother = 1L, number_of_mcmc_samples = 1000L, global_genotyping_error_rates = TRUE, concentration = 1.) {
