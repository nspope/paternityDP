...
genotyping_error_model <- function(phenotype, genotype0, genotype1, number_of_alleles, dropout_rate, mistyping_rate, dropout_rate_gradient, mistyping_rate_gradient) {
    .Call(`_sydneyPaternity_genotyping_error_model`, phenotype, genotype0, genotype1, number_of_alleles, dropout_rate, mistyping_rate, dropout_rate_gradient, mistyping_rate_gradient)
}
